...
from getBoxes import *
from getCurrentFrame import *
...
while True:
    ...
    class_ids , confidences , boxes = getBoxes(outs,width,height)

    font = cv2.FONT_HERSHEY_PLAIN
 


    curr_frame , classes = getCurrentFrame(class_ids , confidences , boxes)
